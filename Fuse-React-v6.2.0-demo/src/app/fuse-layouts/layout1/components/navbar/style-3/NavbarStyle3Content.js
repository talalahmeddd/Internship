...
function NavbarStyle3Content(props) {
    ...
    return ( <
        ...
        <
        img className = "w-44 my-32"
        src = "assets/images/logos/fuse.svg"
        alt = "logo" /
        >

        <
        FuseScrollbars className = "flex flex-1 min-h-0 justify-center w-full overflow-y-auto overflow-x-hidden"
        option = {
        ...
        firstLevel selectedId = { selectedNavigation[0] ? .id }
        dense = { props.dense }
        /> <
        /FuseScrollbars> <
        /div> <
        /ThemeProvider> {
            selectedNavigation.length > 0 && ( <
                FuseScrollbars id = "fuse-navbar-panel"
                className = {
                    clsx(
                        classes.panel,
                        panelOpen && "opened",
